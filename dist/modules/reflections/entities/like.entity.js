...
__decorate([
    ...
    __metadata("design:type", Number)
], Like.prototype, "reflectionId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => reflection_entity_1.Reflection, (reflection) => reflection.likes, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'reflection_id' }),
    __metadata("design:type", reflection_entity_1.Reflection)
], Like.prototype, "reflection", void 0);
exports.Like = Like = __decorate([
    (0, typeorm_1.Entity)('likes'),
    (0, typeorm_1.Unique)(['userId', 'reflectionId'])
], Like);
